            ...
            <div class="form_builder" style="margin-top: 25px">
                <div class="row">
                    ...
                    <div class="col-md-5 bal_builder">
                        <div class="form_builder_area"> Drag here</div>
                    </div>
                    <div class="col-md-5">
                        <div class="col-md-12">
                            <form class="form-horizontal" method="post" action="result.php" id="form1">
                                <div class="preview"></div>
                                <div style="display: none" class="form-group plain_html"><textarea rows="50" class="form-control" name="inputText"></textarea></div>
